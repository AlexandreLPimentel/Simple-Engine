...
struct AutoReg : NonCopyable {
    ...
    #define INTERNAL_CATCH_TESTCASE2( TestName, ... ) \
        ...
        namespace{ Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME( autoRegistrar )( Catch::makeTestInvoker( &TestName ), CATCH_INTERNAL_LINEINFO, "", Catch::NameAndTags{ __VA_ARGS__ } ); } /* NOLINT *_ \
    ...
    #define INTERNAL_CATCH_METHOD_AS_TEST_CASE( QualifiedMethod, ... ) \
        CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS \
        namespace{ Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME( autoRegistrar )( Catch::makeTestInvoker( &QualifiedMethod ), CATCH_INTERNAL_LINEINFO, "&" #QualifiedMethod, Catch::NameAndTags{ __VA_ARGS__ } ); } /* NOLINT *_ \
        CATCH_INTERNAL_UNSUPPRESS_GLOBALS_WARNINGS
    ...
    #define INTERNAL_CATCH_TEST_CASE_METHOD2( TestName, ClassName, ... )\
        ...
        namespace{ \
            ...
            Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME( autoRegistrar ) ( Catch::makeTestInvoker( &TestName::test ), CATCH_INTERNAL_LINEINFO, #ClassName, Catch::NameAndTags{ __VA_ARGS__ } ); /* NOLINT *_ \
        } \
        CATCH_INTERNAL_UNSUPPRESS_GLOBALS_WARNINGS \
        void TestName::test()
    ...
    #define INTERNAL_CATCH_REGISTER_TESTCASE( Function, ... ) \
        CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS \
        Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME( autoRegistrar )( Catch::makeTestInvoker( Function ), CATCH_INTERNAL_LINEINFO, "", Catch::NameAndTags{ __VA_ARGS__ } ); /* NOLINT *_ \
        CATCH_INTERNAL_UNSUPPRESS_GLOBALS_WARNINGS
...
namespace Catch {
    ...
    // raise() called from it, i.e. one stack frame below.
        ...
        #define CATCH_TRAP() asm volatile ("int $3") /* NOLINT *_
...
namespace Catch {
    ...
    struct StreamingReporterBase : IStreamingReporter {
        ...
        void sectionEnded(SectionStats const& /* _sectionStats *_) override {
            m_sectionStack.pop_back();
        }
        void testCaseEnded(TestCaseStats const& /* _testCaseStats *_) override {
            currentTestCaseInfo.reset();
        }
        void testGroupEnded(TestGroupStats const& /* _testGroupStats *_) override {
            currentGroupInfo.reset();
        }
        void testRunEnded(TestRunStats const& /* _testRunStats *_) override {
            currentTestCaseInfo.reset();
            currentGroupInfo.reset();
...
namespace Catch {
    ...
    std::size_t listReporters( Config const& /*config*_ );
...
namespace Catch {
    ...
    public:
        ...
        void noMatchingTestCases( std::string const& /*spec*_ ) override {}
